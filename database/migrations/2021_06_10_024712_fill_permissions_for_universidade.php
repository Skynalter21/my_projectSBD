...
class FillPermissionsForUniversidade extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUniversidade constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.universidade',
            'admin.universidade.index',
            'admin.universidade.create',
            'admin.universidade.show',
            'admin.universidade.edit',
            'admin.universidade.delete',
            'admin.universidade.bulk-delete',
        ]);
