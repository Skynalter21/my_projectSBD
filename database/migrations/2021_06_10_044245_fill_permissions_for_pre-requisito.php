...
class FillPermissionsForPreRequisito extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPreRequisito constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.pre-requisito',
            'admin.pre-requisito.index',
            'admin.pre-requisito.create',
            'admin.pre-requisito.show',
            'admin.pre-requisito.edit',
            'admin.pre-requisito.delete',
            'admin.pre-requisito.bulk-delete',
        ]);
