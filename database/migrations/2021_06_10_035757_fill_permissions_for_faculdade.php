...
class FillPermissionsForFaculdade extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFaculdade constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.faculdade',
            'admin.faculdade.index',
            'admin.faculdade.create',
            'admin.faculdade.show',
            'admin.faculdade.edit',
            'admin.faculdade.delete',
            'admin.faculdade.bulk-delete',
        ]);
