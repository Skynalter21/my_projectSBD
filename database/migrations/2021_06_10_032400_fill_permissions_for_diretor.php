...
class FillPermissionsForDiretor extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDiretor constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.diretor',
            'admin.diretor.index',
            'admin.diretor.create',
            'admin.diretor.show',
            'admin.diretor.edit',
            'admin.diretor.delete',
            'admin.diretor.bulk-delete',
        ]);
