...
class FillPermissionsForProfessor extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProfessor constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.professor',
            'admin.professor.index',
            'admin.professor.create',
            'admin.professor.show',
            'admin.professor.edit',
            'admin.professor.delete',
            'admin.professor.bulk-delete',
        ]);
