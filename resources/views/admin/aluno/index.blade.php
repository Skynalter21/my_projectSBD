                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'nome'">{{ trans('admin.aluno.columns.nome') }}</th>
                                        <th is='sortable' :column="'nascimento'">{{ trans('admin.aluno.columns.nascimento') }}</th>
                                        <th is='sortable' :column="'telefone'">{{ trans('admin.aluno.columns.telefone') }}</th>
                                        <th is='sortable' :column="'faltas'">{{ trans('admin.aluno.columns.faltas') }}</th>
                                        <th is='sortable' :column="'cra'">{{ trans('admin.aluno.columns.cra') }}</th>
                                        <th is='sortable' :column="'FK_idTurma'">{{ trans('admin.aluno.columns.FK_idTurma') }}</th>
                                        <th is='sortable' :column="'FK_idOrientador'">{{ trans('admin.aluno.columns.FK_idOrientador') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        ...
                                        <td>@{{ item.faltas }}</td>
                                        <td>@{{ item.cra }}</td>
                                        <td>@{{ item.FK_idTurma }}</td>
                                        <td>@{{ item.FK_idOrientador }}</td>
