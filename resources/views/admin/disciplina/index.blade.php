                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'sigla'">{{ trans('admin.disciplina.columns.sigla') }}</th>
                                        <th is='sortable' :column="'numCreditos'">{{ trans('admin.disciplina.columns.numCreditos') }}</th>
                                        <th is='sortable' :column="'FK_idTurma'">{{ trans('admin.disciplina.columns.FK_idTurma') }}</th>
                                        <th is='sortable' :column="'FK_idProfessor'">{{ trans('admin.disciplina.columns.FK_idProfessor') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        <td>@{{ item.nome }}</td>
                                        <td>@{{ item.sigla }}</td>
                                        <td>@{{ item.numCreditos }}</td>
                                        <td>@{{ item.FK_idTurma }}</td>
                                        <td>@{{ item.FK_idProfessor }}</td>
